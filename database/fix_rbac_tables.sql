-- Fix RBAC table conflicts
-- Rename old table and create proper many-to-many structure

-- Step 1: Rename old role_permissions to role_permissions_old
RENAME TABLE role_permissions TO role_permissions_old;

-- Step 2: Create new role_permissions table (proper many-to-many)
...
('salary.edit', 'Propose salary changes', 'salary'),
...
('payroll.verify', 'Verify payroll', 'payroll'),
