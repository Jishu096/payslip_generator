...
<head>
    ...
    <title>Edit Department - Enterprise Payroll Solutions</title>
...
<body>
    ...
    <main class="main-content" id="mainContent">
        <div class="form-container">
            ...
            <form method="POST" action="../index.php?page=update-department&id=<?php echo urlencode($department['department_id']); ?>">
                <div class="form-group">
                    <label>Department ID</label>
                    <input type="text" disabled value="<?php echo htmlspecialchars($department['department_id']); ?>">
                    <p class="dept-id">Auto-generated ID</p>
                </div>
